...
use dioxus::prelude::*;
use axum::{Router, Server, routing::get, response::Html};
                ...
                div { class: "xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0",
                    form {
                        div { class: "flex flex-row items-center justify-center lg:justify-start",
                            ...
                            button { class: "inline-block p-3 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mx-1",
                                "data_mdb_ripple_color": "light",
                                "data_mdb_ripple": "true",
                                r#type: "button",
                                /* Facebook */
                                svg { class: "w-4 h-4",
                            ...
                            button { class: "inline-block p-3 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mx-1",
                                ...
                                svg { class: "w-4 h-4",
                                    ...
                                    /* ! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */
                                    path {
                                        d: "M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274
    -44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-
...
#[tokio::main]
async fn main() {
    let app = Router::new().route("/",get(hola))
        .route("/tailwindcss.css", get(style));;
    ...
    loop {
        match map(&mut atm, &connection).await {
            Err(error) => {
                println!("Error: {}", error);
            },
            Ok(_) => {}
